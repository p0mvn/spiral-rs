...
pub fn sub_modular(params: &Params, a: u64, b: u64, c: usize) -> u64 {
    let val = a + params.moduli[c] - barrett_coeff_u64(params, b, c);
    barrett_coeff_u64(params, val, c)
}

pub fn invert_modular(params: &Params, a: u64, c: usize) -> u64 {
    (params.moduli[c] - a) % params.moduli[c]
}
